...
extension UIColor {
  ...
  class var textGrey: UIColor {
    ...
    class var backGroundColor: UIColor {
        return colorFromDecimalRGB(186, 104, 200)
    }
    class var circleButtonColor: UIColor {
        return colorFromDecimalRGB(144, 202, 249)
    }
    class var emptyViewColor: UIColor {
        return colorFromDecimalRGB(171, 71, 188)
    }
}
